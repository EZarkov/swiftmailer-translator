...
class TranslateDecoratorPluginTest extends PHPUnit_Framework_TestCase {
    ...
    private $_event;
    private $_decorator;
    private $_subject = 'Important message for  {FirstName} {LastName}';
    private $_body = 'Hello {FirstName}, we want to  inform you about new product that we offer.';
